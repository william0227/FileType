...
namespace Program01
{
    ...
    class HeaderOnly : FileClass
    {
        ...
        public override void DetectType()
        {
            ...
            //其他类型
            if (fileString.IndexOf("0D444F43") != -1)
            {
                Console.WriteLine("DOC"); return;
            }

            if (fileString.IndexOf("464C5601") != -1)
            {
                Console.WriteLine("FLV"); return;
            }

            if (fileString.IndexOf("494433") != -1)
            {
                Console.WriteLine("MP3"); return;
            }
            if (fileString.IndexOf("504B0304") != -1)
            {
                Console.WriteLine("ZIP"); return;
            }
            if (fileString.IndexOf("377ABCAF271C") != -1)
            {
                Console.WriteLine("7Z"); return;
            }
            if (fileString.IndexOf("3026B2758E66CF11A6D9") != -1)
            {
                Console.WriteLine("ASF/WMA/WMV"); return;
            }
            if (fileString.IndexOf("526172211A0700") != -1)
            {
                Console.WriteLine("RAR"); return;
            }
            if (fileString.IndexOf("435753") != -1)
            {
